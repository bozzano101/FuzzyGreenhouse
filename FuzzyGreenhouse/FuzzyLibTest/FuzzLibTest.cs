...
namespace FuzzyLibTest
{
    ...
    public class FuzzLibTest
    {
        ...
        public void FuzzLibExampleTest()
        {
            ...
            potrosnja.Add(new FuzzyInput("mala", new List<float> { 3, 10 }, new List<float> { 1, 0 }, 9));
            potrosnja.Add(new FuzzyInput("srednja", new List<float> { 7, 10, 12, 15 }, new List<float> { 0, 1, 1, 0 }, 9));
            potrosnja.Add(new FuzzyInput("velika", new List<float> { 12, 15}, new List<float> { 0, 1 }, 9));

            List<FuzzyInput> pouzdanost = new List<FuzzyInput>();
            pouzdanost.Add(new FuzzyInput("visoka", new List<float> { 5, 10 }, new List<float> { 1, 0 }, 8));
            pouzdanost.Add(new FuzzyInput("niska", new List<float> { 8, 15 }, new List<float> { 0, 1}, 8));

            List<FuzzyOutput> vrednost = new List<FuzzyOutput>();
            vrednost.Add(new FuzzyOutput("mala", new List<float> { 7, 15 }, new List<float> { 1, 0 }));
            vrednost.Add(new FuzzyOutput("srednja", new List<float> { 7, 15, 25, 40 }, new List<float> { 0, 1, 1, 0 }));
            vrednost.Add(new FuzzyOutput("velika", new List<float> { 25, 40 }, new List<float> { 0, 1}));
